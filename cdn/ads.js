...
document.writeln('<script type="text/javascript" src="https://lord-media.com/cdn/lord-media-click-protection.js"></script>');

// start lord media interstitial ads //
      window.googletag = window.googletag || {cmd: []};
      var interstitialSlot, staticSlot;
      googletag.cmd.push(function() {
interstitialSlot = googletag.defineOutOfPageSlot( '/22561025441/egy4ever.com', googletag.enums.OutOfPageFormat.INTERSTITIAL);
      if (interstitialSlot) {
        ...
        staticSlot = googletag.defineSlot('/22561025441/egy4ever.com', [[300, 250], [336, 280]], 'static-ad-1').addService(googletag.pubads());
...
window.googletag = window.googletag || {cmd: []};
    googletag.cmd.push(function() {
    googletag.defineSlot('/22561025441/egy4ever.com', [468, 60], 'gpt-passback-lord-media-anchor-sticky-top').addService(googletag.pubads());
    googletag.enableServices();
...
window.googletag = window.googletag || {cmd: []};
    googletag.cmd.push(function() {
    googletag.defineSlot('/22561025441/egy4ever.com', [468, 60], 'gpt-passback-lord-media-anchor-sticky-buttom').addService(googletag.pubads());
    googletag.enableServices();
...
window.googletag = window.googletag || {cmd: []};
    googletag.cmd.push(function() {
    googletag.defineSlot('/22561025441/egy4ever.com', [[728, 90], [468, 60]], 'gpt-passback-lord-media-anchor-sticky-top').addService(googletag.pubads());
    googletag.enableServices();
    googletag.display('gpt-passback-lord-media-anchor-sticky-top');
    });
...
window.googletag = window.googletag || {cmd: []};
    googletag.cmd.push(function() {
    googletag.defineSlot('/22561025441/egy4ever.com', [[728, 90], [468, 60]], 'gpt-passback-lord-media-anchor-sticky-buttom').addService(googletag.pubads());
    googletag.enableServices();
    googletag.display('gpt-passback-lord-media-anchor-sticky-buttom');
    });
} //end if mobile

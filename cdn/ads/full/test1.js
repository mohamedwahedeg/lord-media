...
// start banners //
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia1').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia2').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia3').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia4').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia5').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia6').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w, [[336, 280], [300, 250], 'fluid'], 'lordmedia7').addService(googletag.pubads());
  // end banners //
googletag.defineSlot('/'+ n +'/'+ w, [[300, 75], [300, 50], [300, 100]], 'gpt-passback-13').addService(googletag.pubads());
//sticky//
googletag.defineSlot('/'+ n +'/'+ w,[[728,90],[300, 100]],'gpt-passback-lord-media-anchor-sticky-top').addService(googletag.pubads());
googletag.defineSlot('/'+ n +'/'+ w,[[728,90],[300, 100]],'gpt-passback-lord-media-anchor-sticky-buttom').addService(googletag.pubads());
...
recapatcha.setAttribute("async","async");
